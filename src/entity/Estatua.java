...
public class Estatua extends Entity {


    public Estatua(GamePanel gp, int startX, int startY) {
        super(gp);
        this.x = startX;
        this.y = startY;
        loadSprites();
    ...
    private void loadSprites() {
        try {
            idle = ImageIO.read(getClass().getResourceAsStream("/objetos/Estatua.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
