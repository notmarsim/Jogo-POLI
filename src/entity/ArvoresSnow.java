...
public class ArvoresSnow extends Entity {


    public ArvoresSnow(GamePanel gp, int startX, int startY) {
        super(gp);
        this.x = startX;
        this.y = startY;
        loadSprites();
    ...
    private void loadSprites() {
        try {
            idle = ImageIO.read(getClass().getResourceAsStream("/objetos/arvoresSnow.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
