...
public class CasaGrande extends Entity{
    private GamePanel gp;
    private int startX;
    private int startY;
    public CasaGrande(GamePanel gp, int startX, int startY) {
        super(gp);
        this.gp = gp;
        this.x = startX;
        this.y = startY;
    ...
    private void loadSprites() {
        try {
            image1 = ImageIO.read(getClass().getResourceAsStream("/objetos/casaGrande.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
