...
public class UI {
    ...
    public void drawInventory() {
        ...
        int frameY = gamePanel.tamanhoJanela + 70;
        int frameWidth = gamePanel.tamanhoJanela * 6;
        int frameHeight = gamePanel.tamanhoJanela * 7;
        ...
        SuperObject selectedItem = null;
        if (selectedIndex >= 0 && selectedIndex < gamePanel.getPlayer().inventario.size()) {
            selectedItem = gamePanel.getPlayer().inventario.get(selectedIndex);
        ...
        // janela da descriçao do item
        int descFrameX = frameX - frameWidth - 20;
        int descFrameY = frameY + 50;
        ...
        // foto imagem do item na descrição
        if (selectedItem != null && selectedItem.image != null) {
            Image itemImage = (Image) selectedItem.image;
            int imageWidth = gamePanel.tamanhoJanela * 2;
            int imageHeight = gamePanel.tamanhoJanela * 2;
            int imageX = descFrameX + (descFrameWidth - imageWidth) / 2;
            int imageY = descFrameY + descFrameHeight - imageHeight - 10;
            g2.drawImage(itemImage, imageX, imageY, imageWidth, imageHeight, null);
        }
    }
